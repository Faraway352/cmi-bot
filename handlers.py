...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "👋 Добро пожаловать в официальный бот МКУ «Центр молодежных инициатив»!\n"
        "Здесь вы сможете записываться на мероприятия, общаться с участниками "
        "и быть в курсе всех событий.\n\n"
