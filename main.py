...
from handlers import (
    cmd_start, process_phone_contact, process_phone_manually, process_full_name, process_gender, process_birthday,
    main_menu_handler, profile_menu_handler, process_callback_main_menu,
    edit_full_name, edit_phone, edit_gender_callback, edit_birthday, edit_vk, edit_tg_username, edit_email,
...
async def healthcheck(request): return web.Response(text="OK")
...
async def main():
    ...
    # Главное меню
    dp.message.register(main_menu_handler, F.text.in_(["👤 Личный кабинет", "📋 Мои записи", "🎉 Афиша", "💬 Оставить отзыв"]))
    ...
    dp.callback_query.register(profile_menu_handler, F.data.in_([
        ...
        "edit_vk", "edit_tg_username", "edit_email", "notify_settings", "toggle_notify", "profile_menu"
    ]))
